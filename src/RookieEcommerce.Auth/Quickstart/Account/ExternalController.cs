...
namespace RookieEcommerce.Auth.Quickstart.Account
{
    ...
    public class ExternalController : Controller
    {
        ...
        private async Task<(BaseApplicationUser user, string provider, string providerUserId, IEnumerable<Claim> claims)>
        ...
        private async Task<BaseApplicationUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
